...
<div class="modal fade" id="exampleMods" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Data Project
      ...
      <div class="modal-body">
        <form class="form-horizontal form-label-left" action="/project/info/audit" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
<div class="form-group">
    <label for="first-name">No Audit
        <span class="required">
        </span>
    </label>
    <input type="text" name="no_audit" id="first-name" required="required" class="form-control ">
</div>
<div class="form-group">
    <label for="first-name">Nama supplier
        <span class="required">
        </span>
    </label>
    <input type="text" name="nama_supplier" id="first-name" required="required" class="form-control ">
</div>
<div class="form-group">
    <label for="first-name">Nama BB/BK/Produk
        <span class="required">
        </span>
    </label>
    <input type="text" name="nama_bb" id="first-name" required="required" class="form-control ">
</div>
<div class="form-group">
    <label for="first-name">tanggal audit
        <span class="required">
        </span>
    </label>
    <input type="date" name="tanggal_audit" id="first-name" required="required" class="form-control ">
</div>
<div class="form-group">
    <label for="first-name">Auditor
        <span class="required">
        </span>
    </label>
    <input type="text" name="auditor" id="first-name" required="required" class="form-control ">
</div>
<div class="form-group">
    <label for="first-name">Auditee
        <span class="required">
        </span>
    </label>
    <input type="text" name="auditee" id="first-name" required="required" class="form-control ">
</div>
<div class="form-group">
    <label for="exampleFormControlSelect1" class="">status
    </label>
    <select name="status" class="form-control form-control " id="exampleFormControlSelect1">
        <option value="A">A
        </option>
        <option value="B">B
        </option>
...
<div class="modal fade" id="exampleModx" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Data Project
      ...
      <div class="modal-body">
        <form class="form-horizontal form-label-left" action="/project/info/fhs" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
<div class="form-group">
    <label for="first-name">Ketidaksesuaian
        <span class="required">
        </span>
    </label>
    {{--
            <input type="text" name="ketidaksesuaian" id="first-name" required="required" class="form-control "> --}}
    {{-- <textarea name="ketidaksesuaian" id="" class="form-control" cols="20" rows="10">
            </textarea>
          </div>
          <div class="form-group">
            <label for="exampleFormControlSelect1" class="">kategori
            </label>
            <select name="kategori" class="form-control form-control " id="exampleFormControlSelect1">
