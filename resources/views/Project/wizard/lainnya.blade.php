                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    {{-- <p>This is a basic form wizard example that inherits the colors from the selected scheme.</p> --}}
                      <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <li>
                          ...
                          <a href="/project/{{$p->id}}/releted">  
                          @endforeach
                              <span class="step_no" style="background :#0095ff !important">...</span>
                  ...
                  <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" style="display: table-cell;">Dokumen Legalitas </th>
                            <th class="column-title" style="display: table-cell;">MOU & NDA </th>
                            <th class="column-title" style="display: table-cell;">Data Trail </th>
                            <th class="column-title no-link last" style="display: table-cell;"><span class="nobr">Follow up</span>
                            </th>
                  ...
                  <div class="form-group">
                      <div class="col-md-3 col-sm-4 col-xs-12 col-md-offset-9">
                          @foreach($project as $p)
                          <a href="/project/{{$p->id}}/releted"><button type="button" class="btn btn-primary">Previous</button>
                          </a>
                          <a href="/project/{{$p->id}}/releted">
                      @endforeach
