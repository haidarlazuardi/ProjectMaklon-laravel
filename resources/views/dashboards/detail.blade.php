...
<a href=">click
                                                        ...
                                                        {{-- <div class="card">
                                                                <td><a class="tooltips btn btn-warning"  data-toggle="modal" data-target="#exampleModal" >Reset PKP</a>
                                                                      ...
                                                                      <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                          ...
                                                                          <div class="modal-body">
                                                                            <form class="form"
                                                                            action="/dashboard/reset" method="post"
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control" name="email_body" id="message-text"></textarea>
                                                                              </div>
